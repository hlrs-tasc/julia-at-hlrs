-- Module file for Julia with the OpenMPI MPI implementation and CUDA support
--
...
whatis("Description: The Julia programming language with OpenMPI as the MPI backend and CUDA support.")
